...
export class RegisterStudentService {
    ...
    getAllFormData(): RegisterStudentInterface {
        this.updateFormData();
        return {
        ...
        carrer: this.studentForm.value.carrer
        }
    }
    resetForm() {
    ...
    async registerUser(userData: RegisterStudentInterface): Promise<any> {
        return this.http.post(`${environment.API_URL}${environment.ADMIN_PATH}/create-student`, userData).toPromise();
    }
}
